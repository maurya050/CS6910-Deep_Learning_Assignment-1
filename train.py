...
parser.add_argument('-wp' , '--wandb_project', help='Project name used to track experiments in Weights & Biases dashboard' , type=str, default='CS6910_Assignment_1')
parser.add_argument('-we', '--wandb_entity' , help='Wandb Entity used to track experiments in the Weights & Biases dashboard.' , type=str, default='Shivam_Maurya')
...
parser.add_argument('-beta1', '--beta1', help='Beta1 used by adam and nadam optimizers.',type=float, default=0.09)
...
parser.add_argument('-w_d', '--weight_decay', help='Weight decay used by optimizers.',type=float, default=.0001)
...
parser.add_argument('-a', '--activation', help='choices: ["sigmoid", "tanh", "relu"]', type=str, default='relu')
...
act_fun_output = ActivationFunction(arguments.output_activation)
...
print("Testing accuracy", round(accuracy_train, 3))
wandb.finish()
